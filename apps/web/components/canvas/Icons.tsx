...
export const LineIcon = (p: P) => <S {...p}><path d="M4 20L20 4" /></S>;
export const ArrowIcon = (p: P) => <S {...p}><path d="M4 18c6 0 10-4 15-13" /><path d="M14 4h5v5" /></S>;
export const BiArrowIcon = (p: P) => <S {...p}><path d="M5 18c5 0 9-4 14-13" /><path d="M14 4h5v5M4 13v5h5" /></S>;
